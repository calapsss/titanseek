...
export default function RegisterStudentPage() {
  ...
  // Setup camera - similar to kiosk page
  useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-slate-50 to-slate-100">
      <header className="flex items-center p-4 border-b">
        ...
        <h1 className="text-xl font-bold ml-4">Register New Student</h1>
      </header>
              ...
              <div className="relative aspect-video bg-muted rounded-md overflow-hidden">
                ...
                {!isCameraActive && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/50">
                    <p className="text-white">{cameraError ? "Camera error" : "Initializing camera..."}</p>
                  </div>
                )}
              </div>
          ...
          <Card>
            <form onSubmit={handleSubmit}>
              ...
              <CardFooter className="flex justify-end">
                <Button
                  type="submit"
                  disabled={!faceDescriptor || !studentId || !firstName || !lastName || !email || isSubmitting}
                  className="gap-2"
                >
